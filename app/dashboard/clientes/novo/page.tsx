    ...
    if (cleanCep.length === 8) {
      try {
        ...
        if (!data.erro) {
          ...
          setState(data.uf);
          // Focus on number could be done with ref, but let's keep it simple
        }
      } catch (error) {
  ...
  return (
    <div className="space-y-6 animate-in slide-in-from-right-10 duration-500">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-white font-orbitron">Novo Cliente</h1>
          <p className="text-sm text-gray-400">Preencha os dados cadastrais do cliente.</p>
        </div>
      </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
                ...
                <div className="md:col-span-3">
                  <Input
                    ...
                    className="bg-slate-950/60 border-cyan-400/20 text-slate-300 focus:border-cyan-400"
                    disabled={!!street} // Optional: keep editable? Usually better to allow edit
                  />
                </div>
                <div className="md:col-span-1">
                  <Input
